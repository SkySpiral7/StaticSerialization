...
//      try
//      {
//         HeaderSerializableStrategy.readHeader(reader, null, streamReader.getObjectRegistry());
//         fail("Didn't throw");
//      }
//      catch (final StreamCorruptedException actual)
//      {
...
//
//      final HeaderInformation actual = HeaderSerializableStrategy.readHeader(reader, null, streamReader.getObjectRegistry());
//
...
//
//      final HeaderInformation actual1 = HeaderSerializableStrategy.readHeader(reader, null, streamReader.getObjectRegistry());
//      assertEquals(expected, actual1);
//      final HeaderInformation actual2 = HeaderSerializableStrategy.readHeader(reader, null, streamReader.getObjectRegistry());
