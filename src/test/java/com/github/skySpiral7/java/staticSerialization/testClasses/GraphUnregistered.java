...
public final class GraphUnregistered implements StaticSerializable
{
   private final Node root;

   public GraphUnregistered(final Node root)
   {
      this.root = root;
   }

   public static GraphUnregistered readFromStream(final ObjectStreamReader reader)
   {
      return new GraphUnregistered(reader.readObject(Node.class));
   }
   ...
   {
      if (!(obj instanceof GraphUnregistered)) return false;
      final GraphUnregistered other = (GraphUnregistered) obj;
