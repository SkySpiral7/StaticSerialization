...
public class ComparableSugar {
	...
	public static boolean isComparisonResult(int comparisonResult, Comparison operation)
	{
		...
		{
			case 0: return (operation == EQUAL_TO || operation == GREATER_THAN_OR_EQUAL_TO || operation == LESS_THAN_OR_EQUAL_TO);
			case 1: return (operation == NOT_EQUAL || operation == GREATER_THAN_OR_EQUAL_TO || operation == GREATER_THAN);
			//case -1:
			default: return (operation == NOT_EQUAL || operation == LESS_THAN_OR_EQUAL_TO || operation == LESS_THAN);
		}
	}
